...
Để biết chính xác chi phí cho trường hợp của bạn, hãy gửi câu hỏi — luật sư sẽ đánh giá và báo phí miễn phí, không ràng buộc.`,
  ...
  },
  {
    ...
    title: 'Đặt lịch tư vấn luật sư tại Thành phố Hồ Chí Minh — Hướng dẫn chi tiết',
    excerpt:
      'Cách đặt lịch hẹn tư vấn với luật sư tại Thành phố Hồ Chí Minh: chọn hình thức gặp mặt, online hay qua điện thoại, và những lưu ý quan trọng.',
    keyword: 'đặt lịch luật sư tphcm',
    practiceArea: 'dan-su',
    image: `${IMG}/background/bg-office-hallway-e2bffaa5.webp`,
    updated: '2026-05-18',
    body: `Bạn đang ở Thành phố Hồ Chí Minh và cần gặp luật sư để được tư vấn chuyên sâu? **Đặt lịch tư vấn luật sư** trước giúp bạn chủ động thời gian và đảm bảo luật sư đúng chuyên môn sẵn sàng đón tiếp.
...
Phù hợp với các vụ việc phức tạp, cần xem xét nhiều giấy tờ gốc. Văn phòng Apolo Lawyers tọa lạc tại 108 Trần Đình Xu, Phường Cầu Ông Lãnh, Thành phố Hồ Chí Minh — thuận tiện di chuyển từ nhiều khu vực.
...
## Luật sư có thể đại diện tôi tại tòa án Thành phố Hồ Chí Minh không?
...
Nếu vụ việc của bạn khẩn cấp, đừng chờ đến lịch hẹn — hãy gọi trực tiếp tổng đài. Đặt lịch ngay hôm nay để được luật sư chuyên môn của Apolo Lawyers hỗ trợ tận tình.`,
    faqs: [
      ...
      },
      {
        ...
        answer: 'Được. Chúng tôi tư vấn qua video call và Zalo cho khách hàng trên toàn quốc, không chỉ riêng Thành phố Hồ Chí Minh.',
      },
      {
        question: 'Văn phòng Apolo Lawyers ở đâu?',
        answer:
          'Trụ sở chính tại 108 Trần Đình Xu, Phường Cầu Ông Lãnh, Thành phố Hồ Chí Minh. Ngoài ra còn có chi nhánh Đông Sài Gòn tại Tầng 9, Tòa nhà K&M, 33 Ung Văn Khiêm, Phường Thạnh Mỹ Tây.',
      },
    ],
  },
  {
